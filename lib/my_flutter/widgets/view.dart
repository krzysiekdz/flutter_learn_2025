...
class _ViewState extends State<View> with WidgetsBindingObserver {
      ...
      case ViewFocusState.focused:
        switch (event.direction) {
          ...
          case ViewFocusDirection.backward:
            nextFocus =
                _policy.findLastFocus(_scopeNode, ignoreCurrentFocus: true);
  ...
  Widget build(BuildContext context) {
    return RawView(
      view: widget.view,
      deprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner:
          widget._deprecatedPipelineOwner,
      deprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView:
...
class _RawViewElement extends RenderTreeRootElement {
  ...
  void _updateChild() {
    try {
      final Widget child =
          (widget as _RawViewInternal).builder(this, _effectivePipelineOwner);
  ...
  void unmount() {
    if (_effectivePipelineOwner !=
        (widget as _RawViewInternal)._deprecatedPipelineOwner) {
